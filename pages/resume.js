            ...
            <div className="Resume">
                ...
                <section className="Resume__experience">
                    ...
                    <ResumeExperience
                        ...
                        <p>
                            Provided empathetic, enthusiastic leadership while helping grow the company from a small team of eight into a mature organization of over one hundred and twenty people.
                        </p>
                        <p>
                            As Portfolio Director I managed ten project teams working on various commercial and government contracts totaling over $5m in revenue. I managed a portfolio team consisting of over twenty staff members of varying roles including Project Leads, Engineering Managers, Software Engineers, QA Engineers, UX/UI Designers, and Human Factors Engineers. I was also responsible for managing the portfolio financials, budgets and projections, roadmap and vision, and business development activities. I coordinated with the other portfolios to adapt to changing customer and business priorities, ensuring our project teams were positioned well to deliver high quality custom applications to our customers.
                        </p>
                        <p>
